...
new #[Layout('components.layouts.admin-app')] class extends Component {
    ...
    public function mount(Group $group): void
    {
        ...
        $this->showSkills = $group->skills->pluck('name')->toArray();
    }
    ...
    public function updateGroup(): void
    {
        ...
        try {
            DB::transaction(function () {
                ...
                // グループに関連するスキルの登録
                $this->group->skills()->detach();
                foreach ($this->showSkills as $skill) {
                    $this->group->skills()->attach(Skill::where('name', $skill)->first()->id);
                }
            });
...
<div>
    ...
    <div class="rounded-lg border-gray-700 border p-8 bg-gray-850 shadow-xl">
        <h2 class="text-2xl font-bold text-white mb-6 border-b border-gray-700 pb-2">グループ更新</h2>
