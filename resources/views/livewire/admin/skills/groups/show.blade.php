...
new #[Layout('components.layouts.admin-app')] class extends Component {
    ...
    {
        Group::find($this->groupIdToDelete)->delete();
...
<div>
    <div class="rounded-lg border-gray-700 border p-8 bg-gray-850 shadow-xl">
        <h2 class="text-2xl font-bold text-white mb-6 border-b border-gray-700 pb-2">グループ詳細</h2>
        ...
        <div class="space-y-4 pt-3">
            <div class="grid grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.skills.groups.edit', $group->id) }}"
