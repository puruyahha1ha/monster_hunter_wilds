...
new #[Layout('components.layouts.admin-app')] class extends Component {
    ...
    public function updateSeries(): void
    {
        ...
        try {
            ...
            session()->flash('message', 'シリーズが正常に更新されました。');
        } catch (\Exception $e) {
            // エラーメッセージを表示
            session()->flash('error', 'シリーズの更新に失敗しました。' . $e->getMessage());
        }
    }
}; ?>
...
<div>
    ...
    <div class="rounded-lg border-gray-700 border p-8 bg-gray-850 shadow-xl">
        <h2 class="text-2xl font-bold text-white mb-6 border-b border-gray-700 pb-2">シリーズ更新</h2>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <button wire:click.prevent="updateSeries"
